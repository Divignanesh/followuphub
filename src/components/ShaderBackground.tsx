/**
 * ShaderBackground — the "Mesh drift" recipe from the 21st.dev Shader
 * Builder.
 *
 * Dropped in as supplied, with three changes for this codebase:
 *
 *   1. The "use client" directive is gone. It is a Next.js App Router marker
 *      and this is a Vite SPA, where it means nothing.
 *   2. It honours prefers-reduced-motion. The original animates a full-screen
 *      canvas forever; here the WebGL context is never created when the
 *      preference is set, which leaves the canvas transparent and lets the
 *      drawn ground behind it show through instead.
 *   3. It lives here rather than in components/ui/. There is no shadcn setup
 *      in this project and components/ui.tsx is a file, so a components/ui/
 *      directory beside it would make "../components/ui" ambiguous.
 *
 * It renders the same markup on the server and on the client (a bare canvas),
 * so hydration matches. Everything that touches window stays in the effect.
 */
...
const UNIFORMS = {
  colors: [[0.011764705882352941,0.07058823529411765,0.054901960784313725],[0.054901960784313725,0.48627450980392156,0.35294117647058826],[0.48627450980392156,0.8980392156862745,0.4666666666666667],[0.9568627450980393,1,0.7803921568627451],[0.9568627450980393,1,0.7803921568627451],[0.9568627450980393,1,0.7803921568627451],[0.9568627450980393,1,0.7803921568627451],[0.9568627450980393,1,0.7803921568627451]] as [number, number, number][],
  colorCount: 4,
  scale: 1.160,
  intensity: 0.340,
  paramA: 0.500,
